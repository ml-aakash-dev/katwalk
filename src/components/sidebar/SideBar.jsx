        ...
        <div className="sidebar_layer hideLarge">
              ...
              <div className="sidebar active">
                   ...
                   <ul className='sidebar_first_list'>
                       <li className='what_dd'  ref={what_new}>What's New? <img src={dropdown} alt="" onClick={()=> openDropDown()} />
                       ...
                       <li>Bespoke </li>
                       <li className="shop_dd" ref={shop}>Shop <img onClick={()=>openDropDown("shop")} src={dropdown} alt="" />
